 ...
 */
#ifndef OVNIS_WIFI_HELPER_H
#define OVNIS_WIFI_HELPER_H
...
public:
   ...
   */
  static OvnisWifiChannelHelper Default (void);
   ...
   */
  Ptr<OvnisWifiChannel> Create (void) const;
 ...
 *
 */
class OvnisWifiPhyHelper : public WifiPhyHelper,
...
public:
   ...
   */
  static OvnisWifiPhyHelper Default (void);
