 ...
 */
#ifndef OVNIS_ADHOC_WIFI_MAC_H
#define OVNIS_ADHOC_WIFI_MAC_H
 ...
 * network.
 */
class OvnisAdhocWifiMac : public WifiMac
{
public:
...
private:
  ...
  OvnisAdhocWifiMac (const OvnisAdhocWifiMac & ctor_arg);
  OvnisAdhocWifiMac &operator = (const OvnisAdhocWifiMac &o);
